...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDate =  mYear + "/";
        if(mMonth<10){
            mDate =mDate +   "0" + mMonth+"/";
        }else mDate =mDate +    mMonth+"/";
        if(mDay<10){
            mDate = mDate +  "0" + mDay;
        }else mDate = mDate +    mDay;
...
//    }
    ...
    public void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        ...
        mDate = year + "/";
        if(monthOfYear<10){
            mDate = mDate+ "0"+monthOfYear + "/" ;
        }else mDate = mDate+monthOfYear + "/" ;
        if(dayOfMonth<10){
            mDate = mDate+ "0"+dayOfMonth;
